...
/* Function: fann_run
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL fann_type * FANN_API fann_run(const struct fann *ann, fann_type * input);
...
/* Function: fann_get_num_input
   ...
   Get the number of input neurons.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned int FANN_API fann_get_num_input(const struct fann *ann);
...
/* Function: fann_get_num_output
   ...
   Get the number of output neurons.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned int FANN_API fann_get_num_output(const struct fann *ann);
...
/* Function: fann_get_total_connections
   ...
   Get the total number of connections in the entire network.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned int FANN_API fann_get_total_connections(const struct fann *ann);
...
/* Function: fann_get_user_data
   ...
   This function appears in FANN >= 2.1.0
*/
FANN_EXTERNAL void * FANN_API fann_get_user_data(const struct fann *ann);
